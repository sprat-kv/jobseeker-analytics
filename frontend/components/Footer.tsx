				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					...
					<div>
						...
						<ul className="space-y-2 text-default-500">
							<li><a className="text-emerald-700">Story Vault:</a> Log achievements via text, voice, email</li>
							<li><a className="text-emerald-700">Mentor Integration:</a> Trusted colleagues share testimonials</li>
							<li><a className="text-emerald-700">Real-time Analytics:</a> Track which applications lead to interviews</li>
							<li><a className="text-emerald-700">Interview Prep:</a> Talking points from your vault, tailored to the role</li>
						</ul>
					</div>
